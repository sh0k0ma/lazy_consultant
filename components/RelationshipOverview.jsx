...
export default function RelationshipOverview() {
  return (
    <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #e5e7eb", padding: "28px 24px", marginTop: 8 }}>
      <h3 style={{ fontSize: 18, fontWeight: 700, color: "#111827", marginBottom: 16 }}>構造的関係の全体像</h3>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 16 }}>
        {layers.map(l => (
          <div key={l.id} style={{ padding: "16px 18px", borderRadius: 10, background: l.colorLight || "#f9fafb", borderLeft: `3px solid ${l.color}` }}>
      ...
      <div style={{ marginTop: 16, padding: "14px 18px", background: "#f9fafb", borderRadius: 8, fontSize: 13, color: "#4b5563", lineHeight: 1.8 }}>
